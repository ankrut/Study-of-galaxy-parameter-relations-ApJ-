...
%
%We are mainly interested in the RAR model for a particle mass of $mc^2 = \SI{50}{\kilo\eV}$ as a promising candidate motivated by the the recent application of the RAR model to different types of galaxies from dwarfs to ellipticals \citep{RAR-II}. Additionally, we take into account also the NFW and DC14 models in order to properly compare among them.
%
%The three competing dark matter models are explained in more detail in \nameref{sec:dark-matter-models}.
