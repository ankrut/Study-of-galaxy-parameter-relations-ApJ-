...
\end{equation} 
%
where the uncertainty in $V_{\rm DM}$ is calculated from the uncertainties in the other velocity components within \add{linear} error propagation theory. \add{Note that only the uncertainties in the total RCs ($\Delta V_{\rm tot}$) are provided within the SPARC data-set. The uncertainty is therefore given by}
%
